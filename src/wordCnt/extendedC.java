...
public class extendedC {
	            ...
	            {   
	                if(array[i].getName().endsWith(fileTyle)){
	                	...
	                	if(list[0].equals("-l")||list[0].equals("-c")||list[0].equals("-w"))
	                			baseC.count(list[0],array[i].getName());
	                	else if(list[0].equals("-a")){
	                		complex(array[i].getName(),null);
	                	}
	                	}
	                	else if(lenth==3&&(list[0].equals("-l")||list[0].equals("-c")||list[0].equals("-w"))&&(list[1].equals("-l")||list[1].equals("-c")||list[1].equals("-w"))){
	                		baseC.count(list[0],list[1],array[i].getName());
	                	}
	                	else if(lenth==4){
	                		baseC.count(list[0],list[1],list[2],array[i].getName());
	                	}
	                	else if(lenth==8)
	                	{
	                		if(list[0].equals("-a")){
	                		baseC.count(list[1], array[i].getName(),list[7]);
	                		baseC.count(list[2], array[i].getName(),list[7]);
	                		complex(array[i].getName(),list[7]);
	                		stop(array[i].getName(),list[5],list[7]);
	                		}          		
	                	}
    ...
    //统计代码行/空行/注释行
	static void complex(String myfile,String outfile)throws FileNotFoundException {  
		if(outfile==null)
			outfile="result.txt";
    ...
    //调用停用词表，重写统计单词数
	static void stop(String thefile,String txt,String output){
    	int stopcount=0;
    	int wordcount=0;
